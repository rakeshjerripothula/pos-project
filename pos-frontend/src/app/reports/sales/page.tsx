      ...
      <div className="min-h-[calc(100vh-64px)] bg-slate-50 p-3 sm:p-6">
        <div className="max-w-[1400px] mx-auto">
          ...
          {data && data.rows.length > 0 && (
            <div className="grid grid-cols-2 gap-3 mb-4 sm:mb-6 md:grid-cols-4 p-4 sm:p-5 bg-white rounded-xl shadow-sm">
              <div>
                ...
                <table className="w-full border-collapse min-w-[400px]">
                  <thead>
                    <tr className="border-b-2 border-gray-200">
                      <th className="px-2 py-2 sm:px-3 py-2.5 text-xs sm:text-sm font-semibold text-left text-gray-700">Product Name</th>
                      <th className="px-2 py-2 sm:px-3 py-2.5 text-xs sm:text-sm font-semibold text-left text-gray-700">Quantity Sold</th>
                  ...
                  <tbody>
                    {data.rows.map((item, idx) => (
                      <tr key={idx} className="border-b border-gray-100">
                        <td className="px-2 py-2 sm:px-3 py-2.5 text-xs sm:text-sm">{item.productName}</td>
                        <td className="px-2 py-2 sm:px-3 py-2.5 text-xs sm:text-sm">{item.quantitySold}</td>
                        <td className="px-2 py-2 sm:px-3 py-2.5 text-xs sm:text-sm">₹{Number(item.revenue).toFixed(2)}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
